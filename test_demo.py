...
def select_model(args, device):
    ...
    if model_id == 0:
        ...
        from models.FSANet_arch import FSANet
        name, data_range = f"{model_id:02}_FSANet", 1.0
        model_path = os.path.join('model_zoo', 'FSANet.pth')
        model = FSANet(fea_ch=56, conv='EPartialBSConvU', rgb_mean=[0.4488, 0.4371, 0.4040], channel_reduction_rate=2, bias=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default="/hdd/denghui/Dataset/SR/DIV2K_LSDIR", type=str)
